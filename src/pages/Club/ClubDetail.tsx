                      ...
                      <Row gutter={[24, 14]}>
                        ...
                        <Col span={18}>
                          ...
                          <Form.Item label="Năm Thành Lập" name="foundedYear">
                            <Input readOnly value={club?.foundedYear} />
                          </Form.Item>

                          <Form.Item label="Huấn luyện viên" name="coach">
                            <Input readOnly value={club?.coach} />
                          </Form.Item>
                          ...
                          <Form.Item label="Bio" name="bio">
                            <Editor
                              ...
                              apiKey={
                                "t2pqf0u5yvinox5op4ih9bjolkd7vpvtsy0a0ntg4o9avodz"
                              }
                              // onInit={(_evt, editor) => (editorRef.current = editor)}
                              initialValue={club?.bio}
                              init={{
                                height: 500,
                                menubar: false,
                                plugins: [
                      ...
                      <Row gutter={[24, 14]}>
                        <Col span={12}>
                          <Form.Item label="Tên sân vận động" name="stadium">
                            <Input readOnly value={club?.statium} />
                          </Form.Item>
                        </Col>
                        <Col span={12}>
                          <Form.Item label="Sức chứa" name="stadiumCapacity">
                            <Input readOnly value={club?.stadiumCapacity} />
                          </Form.Item>
                        </Col>
                      </Row>
                      <Col span={24}>
                        <Form.Item label="Mô tả SVĐ" name="stadiumDescription">
                          <Input readOnly value={club?.stadiumDescription} />
                        </Form.Item>
                      </Col>
                        ...
                        {club?.stadiumAddress && (
                          <Col span={12}>
                            <Form.Item label="Địa chỉ" name="stadiumAddress">
                              <Input readOnly value={club?.stadiumAddress} />
                            </Form.Item>
                          </Col>
                        )}
                        {club?.stadiumMap && (
                          <Col span={12}>
                            <Form.Item label="Map" name="stadiumCapacity">
                              <Input readOnly value={club?.stadiumMap} />
                            </Form.Item>
                          </Col>
                        )}
                      </Row>
                      ...
                      <div className="col-span-4 sm:col-span-2 md:col-span-2 lg:col-span-1  text-primary">
                        <div className="rounded-md border  border-x-slate-100 bg-[#fffffd] border-b-slate-100 border-t-4 border-t-red-500">
                          ...
                          <div className=" border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.attack.goalsPerMatch ===
                              "number"
                                ? clubStats.attack.goalsPerMatch.toLocaleString(
                                    "en-US"
                                  )
                          ...
                          <div className=" border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.attack.shotsOnTarget ===
                              "number"
                                ? clubStats.attack.shotsOnTarget.toLocaleString(
                                    "en-US"
                                  )
                          ...
                          <div className=" border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.attack.shootingAccuracy ===
                              "number"
                          ...
                          <div className=" border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.attack.keyPass === "number"
                                ? clubStats.attack.keyPass.toLocaleString(
                                    "en-US"
                                  )
                      ...
                      <div className="col-span-4 sm:col-span-2 md:col-span-2 lg:col-span-1">
                        <div className="rounded-md border  border-x-slate-100 bg-[#fffffd] border-b-slate-100 border-t-4 border-t-red-500 text-primary">
                          ...
                          <div className="border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.defence.cleanSheets === "number"
                                ? clubStats.defence.cleanSheets.toLocaleString(
                                    "en-US"
                                  )
                          ...
                          <div className="border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.defence.goalsConceded ===
                              "number"
                          ...
                          <div className="border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.defence.saves === "number"
                                ? clubStats.defence.saves.toLocaleString(
                                    "en-US"
                                  )
                          ...
                          <div className="border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.defence.ownGoals === "number"
                                ? clubStats.defence.ownGoals.toLocaleString(
                                    "en-US"
                                  )
                      ...
                      <div className="col-span-4 sm:col-span-2  md:col-span-2 lg:col-span-1">
                        <div className="rounded-md border  border-x-slate-100 h-fit bg-[#fffffd] border-b-slate-100 border-t-4 border-t-red-500 text-primary">
                          ...
                          <div className="border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.discipline.yellowCard ===
                              "number"
                          ...
                          <div className="border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.discipline.redCard === "number"
                                ? clubStats.discipline.redCard.toLocaleString(
                                    "en-US"
                                  )
                          ...
                          <div className="border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.discipline.fouls === "number"
                                ? clubStats.discipline.fouls.toLocaleString(
                                    "en-US"
                                  )
                          ...
                          <div className="border-b-slate-200 flex justify-between px-2 py-2.5">
                            ...
                            <span className="text-md font-bold">
                              {typeof clubStats.discipline.offsides === "number"
                                ? clubStats.discipline.offsides.toLocaleString(
                                    "en-US"
                                  )
